...
rs1.toFile(os.path.join(RESULT_DIR, f'calcium_conc_{MPI.nhosts}procs.dat.bin'))
...
if MPI.rank == 0:
    with open(os.path.join(RESULT_DIR, f'calcium_conc_{MPI.nhosts}procs.dat'), 'w') as f:
