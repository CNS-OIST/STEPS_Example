...
AMPA_C = smodel.Spec('AMPA_C', mdl_WM)
AMPA_C1 = smodel.Spec('AMPA_C1', mdl_WM)
AMPA_C2 = smodel.Spec('AMPA_C2', mdl_WM)
AMPA_D1 = smodel.Spec('AMPA_D1', mdl_WM)
AMPA_D2 = smodel.Spec('AMPA_D2', mdl_WM)
AMPA_O = smodel.Spec('AMPA_O', mdl_WM)

AMPACC1 = smodel.SReac('AMPACC1', ssys_chans, slhs = [AMPA_C], srhs = [AMPA_C1], kcst = 0.0)
AMPAC1C2 = smodel.SReac('AMPAC1C2', ssys_chans, slhs = [AMPA_C1], srhs = [AMPA_C2], kcst = 0.0)
AMPAC2O = smodel.SReac('AMPAC2O', ssys_chans, slhs = [AMPA_C2], srhs = [AMPA_O], kcst = ro)
    ...
    for j in range(int(Nannulis[i])):
        ...
        if j==0:
            ...
            if i>1:
                ...
                sim_WM.setPatchCount('rings'+str(i)+str(j), 'AMPA_C' , round(AMPA_receptors))
                sim_WM.setPatchCount('rings'+str(i)+str(j), 'AMPA_C1' , 0)
                sim_WM.setPatchCount('rings'+str(i)+str(j), 'AMPA_C2' , 0)
                sim_WM.setPatchCount('rings'+str(i)+str(j), 'AMPA_O' , 0)
                sim_WM.setPatchCount('rings'+str(i)+str(j), 'AMPA_D1' , 0)
                sim_WM.setPatchCount('rings'+str(i)+str(j), 'AMPA_D2' , 0)
...
for l in range(NTIMEPOINTS):
    ...
    for i in range(len(Length)):
        ...
        if i>1:    
            ...
            sim_WM.setPatchSReacK('rings'+str(i)+str(0), 'AMPACC1', 1.0e-3 *rb*Glut[l])    
            sim_WM.setPatchSReacK('rings'+str(i)+str(0), 'AMPAC1C2', 1.0e-3 *rb*Glut[l])
